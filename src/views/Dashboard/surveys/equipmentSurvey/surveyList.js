...
export default class EquipmentSurvey extends Component {
    ...
    componentDidMount() {
        ...
        this.unsubscribe = FirebaseDataService.getSurveys('equipment').onSnapshot(this.onDataChange);
    }
    ...
    deleteSurvey(id) {
        FirebaseDataService.deleteSurvey(id, 'equipment')
            .then(() => {
    ...
    openSurvey(id) {
        this.props.history.push("/surveys/equipment/" + id)
    }
