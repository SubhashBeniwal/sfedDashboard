...
function KisanSurvey(props) {
    ...
    useEffect(() => {
        ...
        FirebaseDataService.getSurveys('kisan').onSnapshot(onDataChange);
    }, [])
    ...
    const deleteSurvey = (id) => {
        FirebaseDataService.deleteSurvey(id, 'kisan')
            .then(() => {
    ...
    const openSurvey = (e, id) => {
        ...
        // e.preventDefault()
        props.history.push("kisanSurvey" + id)
    }
                    ...
                    <CardHeader color="primary" classname={classes.headerTitleBox}>
                        <GridContainer>
                            <GridItem xs={6} sm={6} md={6}>
                                <h4 className={classes.cardTitleWhite}>Kissan Surveys</h4>
                            </GridItem>
                            <GridItem xs={6} sm={6} md={6}>
