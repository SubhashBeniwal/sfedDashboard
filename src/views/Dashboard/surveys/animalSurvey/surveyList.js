...
export default class AnimalSurvey extends Component {
    ...
    componentDidMount() {
        ...
        this.unsubscribe = FirebaseDataService.getSurveys('animal').onSnapshot(this.onDataChange);
    }
    ...
    deleteSurvey(id) {
        FirebaseDataService.deleteSurvey(id, 'animal')
            .then(() => {
    ...
    openSurvey(id) {
        this.props.history.push("/surveys/animal/" + id)
    }
